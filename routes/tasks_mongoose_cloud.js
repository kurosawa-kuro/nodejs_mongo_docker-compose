...
// Get Single Task
router.get("/task_mongoose_cloud/:id", function(req, res, next) {
...
//Save Task
router.post("/task_mongoose_cloud", function(req, res, next) {
  var task = req.body;
...
// Delete Task
router.delete("/task_mongoose_cloud/:id", function(req, res, next) {
...
// Update Task
router.put("/task_mongoose_cloud/:id", function(req, res, next) {
  var task = req.body;
  var updTask = {};
